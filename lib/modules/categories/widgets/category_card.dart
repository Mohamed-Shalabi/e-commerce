...
class CategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: StateConsumer<AppThemesState>(
        initialState: stateHolder.lastStateOfContextType(AppThemesState)
            as AppThemesState,
        builder: (context, state) => MyCard(
          color: state.isLight ? baseColor.shade200 : baseColor.shade900,
          height: 48,
