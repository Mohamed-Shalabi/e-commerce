...
import 'package:e_commerce/core/database/data/category.dart';
import 'package:e_commerce/core/database/data/component.dart';
import 'package:e_commerce/core/database/data/image.dart';
import 'package:e_commerce/core/database/data/product.dart';
...
class DatabaseManager {
  ...
  Future<String> queryUserProfile(int userToken) async {
    ...
    return json.encode(result.first);
  }
  ...
  Future<String> queryCategoryProducts(int categoryId) async {
    ...
    log(products.map((e) => e['title']).toString());
